  ...
  return (
    <div className=' pb-[60px] w-full'>
               <div className=' xl:w-[1140px] sm:w-[540px] md:w-auto mx-auto px-[15px] pt-[70px] '>
                 <h3  className={`${mulish400.className} sm:block hidden text-[#323232] md:text-[27px] text-[16px] leading-[32px] text-center `}>You may also contact us via email at<br/> <span  className={`${mulish800.className}`}>support@praiki.com</span></h3>
                 <h3  className={`${mulish400.className} sm:hidden block text-[#323232] md:text-[27px] text-[16px] sm:leading-[32px] leading-[25px] text-center `}>You may also contact us via email at <span  className={`${mulish800.className}`}>support@praiki.com</span></h3>
