  ...
  return (
    <div  className="    md:pt-[130px] pt-[100px] md:pb-[120px] pb-[50px] w-full"  style={{
        ...
        <div className=' xl:w-[1140px] lg:w-[960px] md:w-[760px] sm:w-[540px] w-full mx-auto px-[15px] sm:pt-[70px] pt-[0px]'>
           ...
           <h2 className={`${mulish400.className} md:block hidden text-post_clr lg:text-[27px] sm:text-[22px] lg:leading-[32px] text-center`}>Have questions about how Freelance works? Want to get in touch or<br/> have an enquiry? We love to hear from you.</h2>
           <h2 className={`${mulish400.className} md:hidden block  text-post_clr lg:text-[27px] sm:text-[22px] text-[18px] lg:leading-[32px] text-center`}>Have questions about how Freelance works? Want to get in touch or have an enquiry? We love to hear from you.</h2>
        </div>
    </div>
  )
}
