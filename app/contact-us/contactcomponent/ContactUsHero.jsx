  ...
  return (
    <div  className="    md:pt-[130px] pt-[100px] md:pb-[120px] pb-[50px] w-full"  style={{
        ...
        <div className=' xl:w-[1140px] lg:w-[960px] md:w-[760px] sm:w-[540px] w-full mx-auto px-[15px] sm:pt-[70px] pt-[0px]'>
           ...
           <h3  className={`${mulish400.className}  text-[#323232] md:text-[27px] text-[16px] sm:leading-[32px] leading-[25px] text-center `}>You may also contact us via email at <span  className={`${mulish800.className}`}>support@freelance.com</span></h3>
        </div>
    </div>
  )
}
